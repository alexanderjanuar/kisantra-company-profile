<footer class="bg-gray-900 text-white">
    ...
    <!-- Back to top button -->
    <button id="backToTop"
        class="fixed bottom-8 right-8 bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-full shadow-lg transition-all duration-300 ease-in-out opacity-0 invisible"
        onclick="scrollToTop()">
