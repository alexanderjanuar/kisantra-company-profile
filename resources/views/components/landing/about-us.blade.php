<div class="relative min-h-screen overflow-hidden bg-white flex items-center">
    ...
    <div class="relative z-10 w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-16 py-20">
        <div class="flex flex-col lg:flex-row gap-12 items-center">
            {{-- Left Section: Images --}}
            <div class="w-full lg:w-1/2 flex gap-2 h-[700px]" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="w-full lg:w-1/2 space-y-2" data-aos="fade-left" data-aos-duration="1000">
                {{-- Header --}}
                <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                    <div class="inline-block bg-blue-50 text-blue-600 px-4 py-2 rounded-lg text-sm font-medium mb-4">
                        Tentang Perusahaan Kami
                    </div>
                    <h1 class="text-3xl sm:text-4xl lg:text-5xl xl:text-[3.5rem] font-bold text-navy-900 leading-tight mb-4"
                        style="color: #1e293b;">
                ...
                {{-- Mission Cards --}}
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4" data-aos="fade-up" data-aos-duration="1000"
                    data-aos-delay="200">
                    {{-- Card 1 --}}
                    <div class="space-y-3">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4" data-aos="fade-up"
                    data-aos-duration="1000" data-aos-delay="400">
                    <a href="#"
                        class="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-semibold transition-colors shadow-lg">
                        Selengkapnya
