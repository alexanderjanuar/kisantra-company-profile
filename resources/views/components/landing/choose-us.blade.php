<div
                ...
                <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="0"
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p
                                class="text-white/80 leading-relaxed transition-all duration-500 group-hover:text-white/95">
    ...
    {{-- Enhanced CSS for animations and smooth hover effects --}}
    <style>
        ...
        .animate-float-delayed {
            animation: float-delayed 9s ease-in-out infinite 2s;
        }

        .animate-bounce-delayed {
            animation: bounce-delayed 7s ease-in-out infinite 1s;
        }
        ...
        .animate-particle-2 {
            animation: particle-2 18s linear infinite 3s;
        }

        .animate-particle-3 {
            animation: particle-3 20s linear infinite 6s;
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const statsSection = document.querySelector('.grid.grid-cols-2.gap-8');
            if (statsSection) {
